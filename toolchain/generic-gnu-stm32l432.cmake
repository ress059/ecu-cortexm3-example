...
# Target = STM32L432 (STM32 NUCLEO-L432KC board).
# Host = Linux x86 machine. This toolchain file requires a Linux x86 host.
message(STATUS "Using toolchain file for cross compiling STM32L432 on Linux x86 host. Must be "
...
set(CMAKE_SYSTEM_PROCESSOR stm32l432 CACHE STRING "")
...
# Set hardware-specific compiler flags for STM32L432, stdlib implementation to use, and
...
set(TOOLCHAIN_SOURCE_FILES "${CMAKE_CURRENT_LIST_DIR}/stm32l432_startup.c" CACHE STRING "")


# Set hardware-specific linker flags for STM32L432, stdlib implementation to use, and
# linker garbage collection flags here since these should apply to the entire project.
# Remaining flags will be added by CMake build system depending on what is needed 
# by the application.
set(CMAKE_EXE_LINKER_FLAGS_INIT "-mcpu=cortex-m4 -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -specs=nano.specs -Wl,-T${CMAKE_CURRENT_LIST_DIR}/stm32l432xc.ld -Wl,-Map=${CMAKE_BINARY_DIR}/${CMAKE_PROJECT_NAME}.map -Wl,--gc-sections" CACHE STRING "")
